...
# Ejecuta tres animacionescon threads
def ejecutar_animacion_threads():
...
# Ejecuta tres animaciones con procesos
def ejecutar_animacion_procesos():
    worker_1 = multiprocessing.Process( name='print x',target=crearAnimacion, args=(10, 10, 'X',))
    worker_2 = multiprocessing.Process( name='print y',target=crearAnimacion, args=(10, 30, 'Y'))
    worker_3 = multiprocessing.Process( name='print z',target=crearAnimacion, args=(10, 50, 'Z'))
    worker_1.start()
    worker_2.start()
    worker_3.start()

# ejecutar_animacion_threads()
ejecutar_animacion_procesos()
